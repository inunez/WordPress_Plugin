...
//            if (strtolower($this->incoming_headers['content-type']) == 'binary/x-gzip'){
...
//                            $this->incoming_headers['content-type'] = 'text/xml; charset=UTF-8';
    ...
    function nusoap_parser($xml, $encoding = 'UTF-8', $method = '', $decode_utf8 = true) {
        ...
        if (!empty($xml)) {
            ...
            if (!xml_parse($this->parser, $xml, true)) {
                ...
                // get final value
                //IAN
                echo '<h2>root</h2><pre>' . $this->root_struct . '</pre>';
                //echo '<h2>XML parse</h2><pre>' . htmlspecialchars(var_dump($this->message), ENT_QUOTES) . '</pre>';
                //$this->root_struct=2;
...
//                $http->setEncoding('gzip, deflate');
                ...
                if (preg_match('/^http:/', $this->endpoint)) {
                    ...
                    //$response = $http->->($msg,$timeout,$response_timeout);
